    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Arsip Berita Acara Seminar Hasil</li>
            </ol>
        </div>
        ...
        <div class="input-group mb-3">
                ...
                <div id="tabelarsipsemhas_persemester" class="table-responsive"></div>
        </div>
        ...
        <div class="input-group mb-3">
                ...
                <div id="tabelarsipsemhas_permahasiswa" class="table-responsive"></div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#semester').change(function(){
            ...
            $.ajax({
                        url : 'getarsipsemhas.php',
                        type:'post',
                        data : 'idsemester='+ id,
                        cache : false,
                        success : function(data)
                        {
                            $('#tabelarsipsemhas_persemester').html(data);
                        }
                    });
            });
        });
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                        ...
                        success : function(data)
                        {
                            $('#tabelarsipsemhas_permahasiswa').html(data);
                        }
                    });
            });
        });
