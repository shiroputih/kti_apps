...
if(isset($_POST["export"])){
     ...
     WHERE assign_sk.id_dosen = '".$_POST['dosen']."'
...
header('Content-Disposition: attachment; filename=trackrecorddosen.xls');
echo $output;
