...
?>
            <form method="POST">
                        ...
                        <button type="submit" name="CreateBeritaAcarakti" class="btn btn-primary btn-md">Simpan</button>
            </form>
<?php
        }
    }
...
?>
            <form method="POST">
                        ...
                        <button type="submit" name="UlangBeritaAcarakti" class="btn btn-primary btn-md">Simpan</button>
            </form>
<?php
        }
    }
...
?>
            <form method="POST">
                        ...
                        <button type="submit" name="UpdateBeritaAcarakti" class="btn btn-primary btn-md">Simpan</button>
            </form>
<?php
        }
    }
