...
if(isset($_POST['idsemester'])){
    ...
    AND proposal.status_proposal = 'Lolos'
        ...
        while ($row = $result->fetch_assoc()) {
            ?>
                <tr>
                    ...
                    <td><?=$row['nim'];?></td>
                    <td><?=$row['nama'];?></td>
                    <td><a href=<?=$row['file_proposal'];?> target='_blank'><img src='icons/pdficon.png' width='30px' height='30px'></a>
                </tr>
<?php
    $no++;
        }
        ...
        while ($row = $result->fetch_assoc()) {
            ?>
                <tr>
                    ...
                    <td><?=$row['nim'];?></td>
                    <td><?=$row['nama'];?></td>
                    <td><a href=<?=$row['file_proposal'];?> target='_blank'><img src='icons/pdficon.png' width='30px' height='30px'></a></td>
                </tr>
