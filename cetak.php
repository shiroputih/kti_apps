				...
				<form id="cetak" action="cetakproposal.php" method="POST" target="_blank">
					<div class="form-group">
						<div class="input-group mb-3">
							...
							<button type="submit" class="btn btn-info btn-medium" >Cetak Berita Acara Proposal</button>
							</a>
						</div>
					</div>
				</form>
					...
					<div class="form-group">
						<div class="input-group mb-3">
							...
							<a href="cetaksemhas.php?nim=<?php echo $nim; ?>" target="_blank">
								<button type="submit" name="cetakberitaacarasemhas" class="btn btn-info btn-medium" >Cetak Berita Acara Seminar Hasil</button>
							</a>
						</div>
					</div>
				</form>
					...
					<div class="form-group">
						<div class="input-group mb-3">
							...
							<a href="cetakkti.php?nim=<?php echo $nim; ?>" target="_blank">
								<button type="submit" name="cetakberitaacarakti" class="btn btn-info btn-medium" >Cetak Berita Acara Ujian KTI</button>
							</a>
						</div>
					</div>					
				</form>
