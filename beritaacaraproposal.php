        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM mahasiswa,proposal,angkatan where mahasiswa.nim = proposal.nim AND angkatan.id_angkatan = proposal.id_angkatan AND mahasiswa.id_angkatan = proposal.id_angkatan AND proposal.status IS NULL";
...
<?php
    if(isset($_POST['UpdateBeritaAcaraProposal']))
    {
        ...
        $sql = "UPDATE proposal SET 
                ...
                {
                    //save to semhas
                    $sql = "INSERT INTO semhas (nim,nama,judulKTI,dosen1,dosen2,penguji,id_angkatan) VALUES ('" . $_POST[hiddennim] . "','" . $_POST[hiddenNama] . "','" . $_POST[hiddenJudul] . "','" . $_POST[hiddenDosen1] . "','" . $_POST[hiddenDosen2]."','".$_POST[ProposalDosenPenguji]."','".$_POST[hiddenAngkatan]."')";
                    if (mysqli_query($conn, $sql)) 
                    {
