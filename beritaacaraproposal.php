            ...
            <form id="formdosen" method="POST">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" name="EditNim" id="EditNim" value = "<?php echo $_POST['nim'];?>" type="text"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" name="EditNama" id="EditNama" type="text" value = "<?php echo $row['nama'];?>"
                                aria-describedby="nameHelp" disabled="">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                ...
                                ><?php echo $row['judulproposal']; ?></textarea>
                            </div>
                            <div class="input-group mb-3">
