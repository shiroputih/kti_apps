    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Arsip Berita Acara Proposal</li>
            </ol>
        </div>
        ...
        <div class="input-group mb-3">
                ...
                <div id="tabelarsipproposal_persemester" class="table-responsive"></div>
        </div>
        ...
        <div class="input-group mb-3">
                ...
                <div id="tabelarsipproposal_permahasiswa" class="table-responsive"></div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#semester').change(function(){
            ...
            $.ajax({
                        url : 'getarsipproposal.php',
                        type:'post',
                        data : 'idsemester='+ id,
                        cache : false,
                        success : function(data)
                        {
                            $('#tabelarsipproposal_persemester').html(data);
                        }
                    });
            });
        });
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                        ...
                        success : function(data)
                        {
                            $('#tabelarsipproposal_permahasiswa').html(data);
                        }
                    });
            });
        });
