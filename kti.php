        ...
        <div id="Table" class="card-body">
            <div id="tablekti" class="table-responsive">
                <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM kti,mahasiswa,angkatan WHERE kti.nim = mahasiswa.nim AND kti.id_angkatan = angkatan.id_angkatan";
                        ...
                        // output data of each row
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <a id ='Viewdatakti' data-nimmahasiswa=$row[nim]  data-namamahasiswa='$row[nama]' data-gelardepan='$row[angkatan]' data-gelarbelakang='$row[tgl_sidangkti]' data-toggle='modal' data-target='#ViewDataktiModal'>
                                <button type='button' class='btn btn-info btn-sm'>Detail</button></a>
                                <a id ='kumpulberkas' data-nimmahasiswa=$row[nim]  data-namamahasiswa='$row[nama]' data-gelardepan='$row[angkatan]' data-gelarbelakang='$row[tgl_sidangkti]' data-toggle='modal' data-target='#KumpulBerkasModal'>
                ...
                <div class="card-body">
                     <form id="formdosen" method="POST">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type='text' class="form-control" id="date" name="tanggalkumpul"  placeholder="DD/MM/YYY"/>
                        </div>
                         <button type="submit" name="UpdateKumpulBerkas" class="btn btn-info btn-lg" >Simpan dan Cetak</button>
                    </form>
                    </form>
                </div>
            </div>
...
<!-- datepicker -->
    ...
    {
        $sql = "UPDATE kti SET 
                tgL_kumpul = '$_POST[tanggalkumpul]'
